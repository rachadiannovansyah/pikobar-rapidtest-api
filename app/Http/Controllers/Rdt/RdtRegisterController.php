...
class RdtRegisterController extends Controller
{
    ...
    public function __invoke(RdtRegisterRequest $request)
    {
        ...
        return response()->json([
            ...
            'event_start_at'            => $event == null ? null : Carbon::parse($event->start_at)->format('Y-m-d H:i:s'),
            'event_end_at'              => $event == null ? null : Carbon::parse($event->end_at)->format('Y-m-d H:i:s'),
