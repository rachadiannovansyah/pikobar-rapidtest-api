...
class CheckinThankYou extends Notification
{
    ...
    {
        return "Yth. {$notifiable->name}. Terima kasih menghadiri Tes Masif COVID19 PIKOBAR. Nomor Pendaftaran: {$notifiable->registration_code}. Datang: {$this->rdtInvitation->attended_at->setTimezone('Asia/Jakarta')}";
    }
